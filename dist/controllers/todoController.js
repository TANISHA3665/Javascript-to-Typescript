...
const editTodo = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    console.log(((_a = todo === null || todo === void 0 ? void 0 : todo.user) === null || _a === void 0 ? void 0 : _a.toString()) !== user._id.toString());
    if (((_b = todo === null || todo === void 0 ? void 0 : todo.user) === null || _b === void 0 ? void 0 : _b.toString()) !== user._id.toString()) {
        res.status(401);
